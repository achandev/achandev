...
I´m Aaron, a backend-focused full-stack developer.
...
|--------------------------|---------------------------------------------------------------------------------|
| DevOps / Infrastructure | CloudFormation, GitHub Actions, Route 53, CloudFront                            |
| API / Messaging         | API Gateway, SQS, EventBridge                                                   |
| Storage / Logging       | DynamoDB, S3, CloudWatch, MongoDB                                               |
| Compute / Processing    | AWS Lambda, Elastic Beanstalk                                                   |
